...
class TestPromptOptimization(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.data = {
            "input_data": cls.raw_texts[:12],
            "desired_output": cls.formatted_results[:12]
        }
    ...
    def test_recommend(self):
        ...
        results = self.recommender.recommend(examples, num_examples, context, 0.9)
    ...
    def test_optimisation(self):
        ...
        generated_prompt = "Extract named entities and classify them (Person, Location, Organization, etc.)."
