...
class TestOptimalNumExamples(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.llm = LLMConnector(provider="openai", model_name="gpt-4o-mini", api_key=api_key, token_limit=5000)
    ...
    def test_optimal_num_examples(self):
        ...
        for num_examples in range(0, 11):  # Test from 0 to 10 examples
            ...
            syntactic_similarity = recommendation.get("syntactic_similarity", 0)
